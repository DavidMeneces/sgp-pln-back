...
class CreateRecipeHandlerTest {
    ...
    void handle() {
        ...
        var ingredients = List.of(new CreateRecipeCommand.RecipeIngredientCommand(UUID.fromString("504f49db-0c26-486e-b037-6775666efc91"), 1));
        //Request
        var request = new CreateRecipeCommand(name, description, instructions, totalCalories, ingredients);
        //Response
