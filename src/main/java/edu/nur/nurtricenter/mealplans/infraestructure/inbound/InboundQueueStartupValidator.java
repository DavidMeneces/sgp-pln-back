...
import edu.nur.nurtricenter.mealplans.infraestructure.outbox.OutboxPublisherProperties;
...
public class InboundQueueStartupValidator {
    ...
    public InboundQueueStartupValidator(ConnectionFactory connectionFactory, InboundSubscriptionProperties inboundProps, OutboxPublisherProperties outboxProps) {
