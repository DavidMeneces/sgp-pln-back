...
public class RabbitOutboxConfig {
    ...
    private Exchange buildExchange(OutboxPublisherProperties props) {
        ...
        return switch (type) {
            case "topic" ->
                    ExchangeBuilder.topicExchange(props.getExchange()).durable(props.isExchangeDurable()).build();
            case "direct" ->
                    ExchangeBuilder.directExchange(props.getExchange()).durable(props.isExchangeDurable()).build();
            case "fanout" ->
                    ExchangeBuilder.fanoutExchange(props.getExchange()).durable(props.isExchangeDurable()).build();
