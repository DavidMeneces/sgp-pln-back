...
public class InboundEventRecorder {
    ...
    public boolean tryStart(UUID eventId, String eventName, String routingKey, UUID correlationId, Integer schemaVersion, LocalDateTime occurredOn, String payload) {
        if (eventId == null) {
            return false;
        }
