...
public class MealPlanUpdatedEvent extends MealPlanEvent {
	...
	public MealPlanUpdatedEvent(UUID vId, UUID vIdNutricionist, UUID vIdPatient, UUID vIdAppointment, UUID vIdSubscription, Integer vTotalDays, LocalDate vStarDate, LocalDate vEndDate, BigDecimal vTotalCalories, List<MealPlanDay> vMealPlanDays) {
