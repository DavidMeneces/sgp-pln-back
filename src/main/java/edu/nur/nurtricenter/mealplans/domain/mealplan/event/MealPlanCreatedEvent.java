...
public class MealPlanCreatedEvent extends DomainEvent {
    ...
    public MealPlanCreatedEvent(UUID id, UUID idNutricionist, UUID idPatient, UUID idAppointment, UUID idSubscription, Integer totalDays, LocalDate starDate, LocalDate endDate, BigDecimal totalCalories, List<MealPlanDay> mealPlanDays) {
        this.id = id;
